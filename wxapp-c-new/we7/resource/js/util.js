...
util.url = function(e, t) {
  ...
  util.request = function(a) {
    ...
    if (-1 == i.indexOf("http://") && -1 == i.indexOf("https://") && (i = util.url(i)),
      ...
      o.length && (o = o[getCurrentPages().length - 1]) && o.__route__ && (i = i + "&m=" + 'zh_jdgjb');
    }
    var s = getSign(i, a.data);
    if (s && (i = i + "&sign=" + s), !i) return !1;
    if (a.showLoading && util.showLoading(), a.cachetime) {
      var u = t(i),
    ...
    wx.request((_defineProperty(e = {
      ...
      _defineProperty(e, "fail", function(e) {
        ...
        if (n && n.data) return a.success && "function" == typeof a.success && a.success(n), !0;
  ...
  //新接口方法
  util.urlnew = function (e, t) {
    var n = getApp(),

      a = n.siteInfo.siterootnew;
      

    if (e && ((e = e.split("/"))[0] && (a += "/" + e[0] + ""), e[1] && (a += "/" + e[1] + ""),
      e[2] && (a += "/" + e[2] + "")), t && "object" === (void 0 === t ? "undefined" : _typeof(t)))
      for (var r in t) r && t.hasOwnProperty(params) && t[r] && (a += "/" + t[r] + "");
  ...
  util.getUserInfo = function(n) {
            ...
            util.request({
              ...
              success: function(e) {
                ...
                e.data.errno || (t.sessionid = e.data.data.sessionid, wx.setStorageSync("userInfo", t),
                  wx.getUserInfo({
                    success: function(e) {
                      t.wxInfo = e.userInfo, //console.log(t), 
                        wx.setStorageSync("userInfo", t), util.request({
    ...
    t.sessionid ? wx.checkSession({
      ...
      fail: function() {
        t.sessionid = "", //console.log("relogin"),
          wx.removeStorageSync("userInfo"), e();
      }
    }) : e();
  },
